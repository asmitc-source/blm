...
export const Route = createFileRoute("/cookies")({
  head: () =>
    pageHead({
      title: "Cookies",
      description: "Cookie policy for BLM: session cookies for sign-in and essential site cookies.",
      path: "/cookies",
    }),
    ...
    <SiteShell>
      <InnerPage eyebrow="Legal" title="Cookies" lede="Last updated 1 September 2026.">
        <div className="max-w-3xl space-y-4 text-[17px] leading-relaxed text-ink-soft">
          <p>
            We use essential cookies to run the site and a session cookie to keep you signed in to a workspace. We do not run a third-party advertising pixel on the marketing pages.
          </p>
